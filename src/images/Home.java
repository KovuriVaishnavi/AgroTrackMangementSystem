...
public int z=0;
    ...
    private void initComponents() {
        ...
        jButton13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/download.png"))); // NOI18N
        jButton13.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                jButton13ComponentShown(evt);
            }
        });
        getContentPane().add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1330, 30, 77, 77));
        ...
        jLabel12.setText("visualization");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 130, 86, -1));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background5.jpg"))); // NOI18N
